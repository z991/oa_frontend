<template>
  <div class="chanp">
      ...
      <p class="cp">
          ...
          <a href="javascript:void(0)" class="wid4">产品功能名称</a>
          <a href="javascript:void(0)" class="wid4">当前版本</a>
...
export default {
  ...
  methods:{
      ...
      versi:function(index){  // 左侧信息的点击事件
          ...
          axioIn.get('/api/product/version/'+pi+'/')
          .then((res)=>{
      ...
      chbao:function(id){ //弹窗处的保存
          ...
          if(this.a5=='新增'){
              axioIn.post('/api/product/ref-product/',pro)
              .then((res)=>{
          ...
          if(this.a5=='修改'){
              pro.version[0].id=o2;
             axioIn.put('/api/product/ref-product/'+id+'/',pro)
              .then((res)=>{
      ...
      incrementTotal:function(q){
          ...
          if(this.search_open===false){
              axioIn.get('/api/product/ref-product/?page='+q)
               .then((res) => {
                this.popp=this.items=res.data.results;
                this.pageIndex=q;
                this.page=res.data.page_num.total_page;
            ...
            .catch((err)=> console.log(err));
              ...
              axioIn.get('/api/product/ref-product/?product_name='+this.messs+'&page='+q)
               .then((res) => {
                this.popp=this.items=res.data.results;
                this.pageIndex=q;
                this.page=res.data.page_num.total_page;
      ...
      ychang:function(n){ // 引用版本处的select的change事件
          if(n===undefined){return}else{
              axioIn.get('/api/product/version/'+n+'/')
          .then((res)=>{
              this.aa1s=res.data.function;
      ...
      produi:  function(){return axioIn.post('/api/product/ref-product/',{product:this.aa2.product});},
      versii:  function(a){
      ...
      produi1:  function(id){return axioIn.put('/api/product/ref-product/'+id+'/',{product:this.aa2.product});},
      ...
      console.log('删除')
         confirm('确认删除？')?
          axioIn.delete('/api/product/ref-product/'+id+'/')
          .then((res)=>{
              alert('删除成功');
              axioIn.get('/api/product/ref-product/')
                .then((res) => {
              ...
              }).catch(err=>{alert(err.data.error)}):0;
